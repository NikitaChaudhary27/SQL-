...
LOAD DATA LOCAL INFILE "C:\\Users\\C\\Downloads\\mobility_data (2)\\users.csv"
INTO TABLE users
...
LOAD DATA LOCAL INFILE "C:\\Users\\C\\Downloads\\mobility_data (2)\\cities.csv"
INTO TABLE cities
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE  "C:\\Users\\C\\Downloads\\mobility_data (2)\\drivers.csv"
INTO TABLE drivers
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE  "C:\\Users\\C\\Downloads\\mobility_data (2)\\vehicles.csv"
INTO TABLE vehicles
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE  "C:\\Users\\C\\Downloads\\mobility_data (2)\\rides.csv"
INTO TABLE rides
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE "C:\\Users\\C\\Downloads\\mobility_data (2)\\payments.csv"
INTO TABLE payments
FIELDS TERMINATED BY ','
OPTIONALLY ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE "C:\\Users\\C\\Downloads\\mobility_data (2)\\ratings_feedback.csv"
...
LOAD DATA LOCAL INFILE "C:\\Users\\C\\Downloads\\mobility_data (2)\\promotions.csv"
